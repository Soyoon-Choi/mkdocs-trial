...
- [Altibase 제품 설치](../Installation%20Guide/2.패키지-인스톨러를-이용한-제품-설치.md#altibase-제품-설치)
...
-   [설치 환경 사전 확인](../Installation%20Guide/2.패키지-인스톨러를-이용한-제품-설치.md#설치-환경-사전-확인)

-   [패키지 인스톨러 다운로드](../Installation%20Guide/2.패키지-인스톨러를-이용한-제품-설치.md#패키지-인스톨러-다운로드_1)

-   [설치 모드 설정](../Installation%20Guide/2.패키지-인스톨러를-이용한-제품-설치.md#설치-모드-설정)

-   [Altibase 패키지 인스톨러 시작](../Installation%20Guide/2.패키지-인스톨러를-이용한-제품-설치.md#altibase-패키지-인스톨러-시작)

-   [설치 디렉터리 입력 및 설치 타입 선택](../Installation%20Guide/2.패키지-인스톨러를-이용한-제품-설치.md#설치-디렉터리-입력-및-설치-타입-선택)
    
-   [시스템 파라미터 확인](../Installation%20Guide/2.패키지-인스톨러를-이용한-제품-설치.md#시스템-파라미터-확인)

-   [Altibase 프로퍼티 설정](../Installation%20Guide/2.패키지-인스톨러를-이용한-제품-설치.md#altibase-프로퍼티-설정)

-   [설정한 프로퍼티 확인](../Installation%20Guide/2.패키지-인스톨러를-이용한-제품-설치.md#설정한-프로퍼티-확인)

-   [Altibase 제품 설치](../Installation%20Guide/2.패키지-인스톨러를-이용한-제품-설치.md#altibase-제품-설치_1)

-   [Altibase 라이선스 입력](../Installation%20Guide/2.패키지-인스톨러를-이용한-제품-설치.md#altibase-라이선스-입력)

-   [Altibase 빠른 설정 가이드 미리 보기](../Installation%20Guide/2.패키지-인스톨러를-이용한-제품-설치.md#altibase-빠른-설정-가이드-미리-보기)

-   [설치 종료](../Installation%20Guide/2.패키지-인스톨러를-이용한-제품-설치.md#설치-종료)

-   [설치 후 작업](../Installation%20Guide/2.패키지-인스톨러를-이용한-제품-설치.md#설치-후-작업)
...
Altibase가 제공하는 운영 체제별 인스톨러는 [패키지 인스톨러 다운로드](../Installation%20Guide/2.패키지-인스톨러를-이용한-제품-설치.md#패키지-인스톨러-다운로드)를 참조하기 바란다.
...
Altibase가 올바르게 실행될 것을 보장하기 위해서 먼저 시스템 환경을 설정할 필요가 있다. Altibase 설치 전에 root 사용자 권한으로 커널 파라미터 값을 조정해야 한다. 커널 파라미터 값은 설치 후에 설정해도 되지만, Altibase를 구동하기 전에는 설정해야 한다. 아래는 각 OS별 시스템 커널 파라미터의 권장 값을 보여주는 예제이다. OS별 커널 파라미터에 대한 자세한 설명은 부록에 있는 "[설치 전 확인 사항](../Installation%20Guide/A.부록-설치-전-확인-사항.md)"을 참조한다.
